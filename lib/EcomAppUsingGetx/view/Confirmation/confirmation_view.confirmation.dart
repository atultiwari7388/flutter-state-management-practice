...
import '../../controller/Confirmation/confirmation_controller.confirmation.controller.dart';

class ConfirmationView extends StatelessWidget {
  ConfirmationView({Key? key}) : super(key: key);

  final controller = Get.put(ConfirmationViewController());
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: text('Discount :', 'Rs. ${controller.totalDiscountPrice}'),
            ),
